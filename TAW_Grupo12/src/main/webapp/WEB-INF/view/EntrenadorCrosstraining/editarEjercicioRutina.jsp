...
<head>
    <title>Editar EjercicioRutina</title>
    <meta charset="utf-8">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a
                    href="http://localhost:8080/entrenadorcross/mostrar/<%=rutina.getIdrutina()%>"><%=rutina.getNombre()%>
            </a></li>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form:form method="post" action="/entrenadorcross/rutina/editar-process"
                               modelAttribute="ejercicioRutinaDTO">
                        ...
                        <div class="form-group">
                            ...
                            <form:input required="required" type="number" min="1" placeholder="Repeticiones"
                                        path="repeticiones" class="form-control"/>
                        </div>

                        <div class="form-group">
                            <label for="peso">Medición/Unidad</label>
                            <form:input placeholder="Medición/Unidad" path="peso" class="form-control"/>
                        </div>

                        <div class="form-group">
                            <label for="ejercicio">Ejercicio</label>
                            <form:select required="required" path="ejercicio" class="form-select"
                                         items="${ejercicioDTOList}" itemLabel="nombre" itemValue="idejercicio">
