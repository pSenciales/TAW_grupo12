...
<div class="parent-container-login">
    ...
    <form:form method="post" action="/autenticar" modelAttribute="usuario" class="form-horizontal">
        ...
        <div class="form-group miForm-group-login">
            ...
            <form:input id="email" path="email" type="email" size="60" maxlength="45" class="form-control miForm-control-login" />
        </div>

        <div class="form-group miForm-group-login">
            <label for="contrasenya" class="col-form-label">Contraseña:</label>
            <form:input id="contrasenya" path="contrasenya" type="password" size="60" maxlength="45" class="form-control miForm-control-login" />
        </div>
