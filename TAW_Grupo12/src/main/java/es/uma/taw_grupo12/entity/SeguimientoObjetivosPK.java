 ...
 */
@Embeddable
public class SeguimientoObjetivosPK implements Serializable {
    ...
    public SeguimientoObjetivosPK() {
    }

    public SeguimientoObjetivosPK(int idejerciciorutina, int idrutina, int idejercicio) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SeguimientoObjetivosPK)) {
            return false;
        }
        SeguimientoObjetivosPK other = (SeguimientoObjetivosPK) object;
    ...
    public String toString() {
        return "es.taw12.app.entity.SeguimientoObjetivosPK[ idejerciciorutina=" + idejerciciorutina + ", idrutina=" + idrutina + ", idejercicio=" + idejercicio + " ]";
    }
